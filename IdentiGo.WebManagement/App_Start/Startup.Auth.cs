...
namespace IdentiGo.WebManagement
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator
                            .OnValidateIdentity<ApplicationUserManager, User, Guid>(
            ...
            if (CurrentUserUtils.UserId == Guid.Empty) 
            {
                new PathString("/Account/Login");
            }
            //var identity = (ClaimsIdentity)User.Identity;
            //throw new SecurityException(string.Format("El usuario {0} esta tratando de acceder a una opción de la aplicación sin haber seleccionado una Empresa."));
